...
step1 = nn.Sequential( # Sequential,
	...
	nn.ConvTranspose2d(512,384,(5, 5),(2, 2),(2, 2)),
	nn.BatchNorm2d(384),
	nn.ReLU(),
	LambdaMap(lambda x: x, # ConcatTable,
		nn.Sequential( # Sequential,
			nn.ConvTranspose2d(384,384,(5, 5),(2, 2),(2, 2)),
			nn.BatchNorm2d(384),
			nn.ReLU(),
			nn.ConvTranspose2d(384,384,(5, 5),(2, 2),(2, 2)),
			nn.BatchNorm2d(384),
			nn.ReLU(),
			nn.ConvTranspose2d(384,192,(5, 5),(2, 2),(2, 2)),
			nn.BatchNorm2d(192),
			nn.ReLU(),
			nn.ConvTranspose2d(192,96,(5, 5),(2, 2),(2, 2)),
			nn.BatchNorm2d(96),
			nn.ReLU(),
